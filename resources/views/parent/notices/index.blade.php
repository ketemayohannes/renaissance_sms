<x-parent-layout header="School Announcements">
    <div class="space-y-6">
        ...
        <div class="relative bg-gradient-to-r from-violet-600 via-indigo-600 to-indigo-700 rounded-3xl p-6 lg:p-8 text-white overflow-hidden shadow-lg shadow-indigo-100 dark:shadow-none">
            ...
            <div class="absolute -left-10 -bottom-10 w-40 h-40 bg-indigo-500/10 rounded-full blur-xl"></div>

            <div class="relative z-10 space-y-2">
                <span class="text-indigo-200 text-xs font-bold tracking-wider uppercase">Renaissance Announcement Board</span>
                ...
                <p class="text-indigo-100 max-w-xl text-sm leading-relaxed pt-1">
                    Stay up-to-date with official events, holidays, schedules, fee policies, and essential letters sent by the school administration.
                </p>
            </div>
        </div>
                ...
                <div class="group relative bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                        <div class="space-y-1">
                            ...
                            <h3 class="text-lg font-black text-slate-800 dark:text-slate-100 font-heading leading-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                                {{ $notice->title }}
                            </h3>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-50 dark:border-slate-800/60">
                        ...
                        <a href="{{ route('parent.notices.show', $notice) }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-200 text-xs">
                            Read Full Notice
                    ...
                    <div class="absolute top-0 bottom-0 left-0 w-1 bg-indigo-600 rounded-l-2xl scale-y-0 group-hover:scale-y-100 transition-transform duration-350 origin-top"></div>
                </div>
            @empty
                <div class="p-12 text-center bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl shadow-sm">
                    ...
                    <p class="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto text-sm">There are currently no active school notifications targeting parents.</p>
                </div>
            @endforelse
        </div>
    </div>
