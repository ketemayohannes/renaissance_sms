            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.students.update', $student) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @endphp
                        <div class="mb-8">
                            <h3 class="text-lg font-medium text-gray-900 border-b pb-2 mb-4">Primary Guardian Information</h3>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="md:col-span-3">
                                    ...
                                    @if($primaryGuardian && $primaryGuardian->photo)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $primaryGuardian->photo) }}" alt="Guardian Photo" class="h-20 w-20 object-cover rounded">
                                        </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_guardian_first_name" id="primary_guardian_first_name" value="{{ old('primary_guardian_first_name', $primaryGuardian->first_name ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_guardian_father_name" id="primary_guardian_father_name" value="{{ old('primary_guardian_father_name', $primaryGuardian->father_name ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_guardian_grandfather_name" id="primary_guardian_grandfather_name" value="{{ old('primary_guardian_grandfather_name', $primaryGuardian->grandfather_name ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_guardian_phone" id="primary_guardian_phone" value="{{ old('primary_guardian_phone', $primaryGuardian->phone ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="primary_guardian_email" id="primary_guardian_email" value="{{ old('primary_guardian_email', $primaryGuardian->email ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <select name="primary_guardian_relationship" id="primary_guardian_relationship" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <option value="">Select Relationship</option>
                                        @foreach(['Father', 'Mother', 'Guardian'] as $rel)
                                            <option value="{{ $rel }}" {{ old('primary_guardian_relationship', $primaryGuardian->relationship ?? '') == $rel ? 'selected' : '' }}>{{ $rel }}</option>
                                        @endforeach
                                    </select>
                        ...
                        @endphp
                        <div class="mb-8">
                            <h3 class="text-lg font-medium text-gray-900 border-b pb-2 mb-4">Secondary Guardian Information (Optional)</h3>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="md:col-span-3">
                                    ...
                                    @if($secondaryGuardian && $secondaryGuardian->photo)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $secondaryGuardian->photo) }}" alt="Guardian Photo" class="h-20 w-20 object-cover rounded">
                                        </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    <input type="text" name="secondary_guardian_first_name" id="secondary_guardian_first_name" value="{{ old('secondary_guardian_first_name', $secondaryGuardian->first_name ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="secondary_guardian_father_name" id="secondary_guardian_father_name" value="{{ old('secondary_guardian_father_name', $secondaryGuardian->father_name ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="secondary_guardian_grandfather_name" id="secondary_guardian_grandfather_name" value="{{ old('secondary_guardian_grandfather_name', $secondaryGuardian->grandfather_name ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="secondary_guardian_phone" id="secondary_guardian_phone" value="{{ old('secondary_guardian_phone', $secondaryGuardian->phone ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="secondary_guardian_email" id="secondary_guardian_email" value="{{ old('secondary_guardian_email', $secondaryGuardian->email ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <select name="secondary_guardian_relationship" id="secondary_guardian_relationship" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <option value="">Select Relationship</option>
                                        @foreach(['Father', 'Mother', 'Guardian'] as $rel)
                                            <option value="{{ $rel }}" {{ old('secondary_guardian_relationship', $secondaryGuardian->relationship ?? '') == $rel ? 'selected' : '' }}>{{ $rel }}</option>
                                        @endforeach
                                    </select>
