<x-admin-layout>
    <x-slot name="header">Import Students</x-slot>
            ...
            <div class="p-6">
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside text-sm text-gray-600 mt-2">
                            ...
                            <li>Required columns: <code>first_name, father_name, grandfather_name, gender, date_of_birth, admission_number, admission_date, grade_level, section_name, primary_guardian_first_name, primary_guardian_phone, primary_guardian_relationship</code></li>
                            <li>Date format should be <code>YYYY-MM-DD</code>.</li>
                            <li>Gender should be <code>M</code> or <code>F</code>.</li>
                        </ul>
                        <div class="mt-4">
                            <a href="{{ route('admin.students.download-template') }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">Download Sample CSV Template</a>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('admin.students.upload') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex justify-end">
                            ...
                            <button type="submit" class="bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Import Students</button>
                        </div>
                    </form>
                </div>
            </div>
