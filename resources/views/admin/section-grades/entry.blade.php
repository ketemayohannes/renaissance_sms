                ...
                <div class="p-6 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    ...
                    <div class="flex gap-4 items-center">
                        ...
                        <a href="{{ route('admin.section-grades.report-card-entry', $section->id) }}?academic_year_id={{$academicYear->id}}&term_id={{$term->id}}" 
                           class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition ease-in-out duration-150 ml-2">
                           Report Card Data
                        </a>
