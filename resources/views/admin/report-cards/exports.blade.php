                ...
                <table class="w-full text-left border-separate border-spacing-0">
                    <thead>
                        <tr class="bg-slate-50/50">
                            ...
                            <th class="px-6 py-4 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Batch Parameters</th>
                            <th class="px-6 py-4 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Deployment Status</th>
                            ...
                            <th class="px-8 py-4 border-b border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-right">Administrative Action</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            <td colspan="5" class="px-12 py-20 text-center">
                                ...
                                <p class="text-slate-500 font-semibold mt-1 text-sm italic">Initiate a bulk certification export from the section management matrix.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
