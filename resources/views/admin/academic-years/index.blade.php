                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form action="{{ route('admin.academic-years.destroy', $year) }}" method="POST" class="inline-block delete-form" data-confirm-message="Are you sure you want to delete this academic year?">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="p-2 hover:bg-white rounded-xl text-slate-400 hover:text-rose-600 transition-all hover:shadow-sm border border-transparent hover:border-slate-100" title="Delete Academic Year">
