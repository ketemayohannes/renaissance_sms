<aside 
    ...
    <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto custom-scrollbar"
        ...
        <div x-show="openCategories['students'] || sidebarCollapsed" x-collapse>
            <a href="{{ route('admin.students.index') }}" class="sidebar-link {{ request()->routeIs('admin.students.*') ? 'sidebar-link-active' : '' }}" title="Learners">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                </svg>
                <span x-show="!sidebarCollapsed" x-transition>Learners</span>
            </a>
        ...
        <div x-show="openCategories['setup'] || sidebarCollapsed" x-collapse>
            ...
            <a href="{{ route('admin.sections.index') }}" class="sidebar-link {{ request()->routeIs('admin.sections.*') || request()->routeIs('admin.grade-levels.*') || request()->routeIs('admin.divisions.*') ? 'sidebar-link-active' : '' }}" title="School Structure">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                </svg>
                <span x-show="!sidebarCollapsed" x-transition>School Structure</span>
            </a>
