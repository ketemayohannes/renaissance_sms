...
<aside 
    ...
    <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto custom-scrollbar"
        ...
        <div x-show="openCategories['students'] || sidebarCollapsed" x-collapse>
            ...
            <a href="{{ route('admin.graduates.index') }}" class="sidebar-link {{ request()->routeIs('admin.graduates.*') ? 'sidebar-link-active' : '' }}" title="Graduates">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="openCategories['services'] || sidebarCollapsed" x-collapse>
            ...
            @endcan
            @can('view library')
            <a href="{{ route('admin.library.index') }}" class="sidebar-link {{ request()->routeIs('admin.library.*') ? 'sidebar-link-active' : '' }}" title="Library">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
