<aside 
    ...
    <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto custom-scrollbar">
        ...
        <div x-show="openCategories['teaching'] || sidebarCollapsed" x-collapse>
            <a href="{{ route('teacher.classes.index') }}" class="sidebar-link {{ request()->routeIs('teacher.classes.*') ? 'sidebar-link-active' : '' }}" title="My Classes">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('teacher.schedule.index') }}" class="sidebar-link {{ request()->routeIs('teacher.schedule.*') ? 'sidebar-link-active' : '' }}" title="My Schedule">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('teacher.inventory-requests.index') }}" class="sidebar-link {{ request()->routeIs('teacher.inventory-requests.*') ? 'sidebar-link-active' : '' }}" title="Inventory Requests">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path>
                </svg>
                <span x-show="!sidebarCollapsed" x-transition>Inventory Requests</span>
            </a>
            @endcan

            @can('view library')
            <a href="{{ route('teacher.library.index') }}" class="sidebar-link {{ request()->routeIs('teacher.library.*') ? 'sidebar-link-active' : '' }}" title="Library">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                </svg>
            ...
            <a href="{{ route('teacher.exams.index') }}" class="sidebar-link {{ request()->routeIs('teacher.exams.*') ? 'sidebar-link-active' : '' }}" title="Exam Papers">
                ...
                <span x-show="!sidebarCollapsed" x-transition>Exam Papers</span>
            </a>
        </div>
        ...
        <div class="sidebar-category-header flex items-center cursor-pointer group mt-4" 
            ...
            <span x-show="!sidebarCollapsed" class="group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors uppercase tracking-widest font-black text-[10px] text-slate-400 dark:text-slate-500">Homeroom</span>
            <span x-show="!sidebarCollapsed">
                <svg class="w-3 h-3 text-slate-400 transition-transform duration-200"
        ...
        <div x-show="openCategories['homeroom'] || sidebarCollapsed" x-collapse>
             <a href="{{ route('teacher.homeroom.index') }}" class="sidebar-link {{ request()->routeIs('teacher.homeroom.index') ? 'sidebar-link-active' : '' }}" title="Class Roster">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('teacher.homeroom.attendance') }}" class="sidebar-link {{ request()->routeIs('teacher.homeroom.attendance') ? 'sidebar-link-active' : '' }}" title="Daily Attendance">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sidebar-category-header flex items-center cursor-pointer group mt-4" 
            ...
            <span x-show="!sidebarCollapsed" class="group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors uppercase tracking-widest font-black text-[10px] text-slate-400 dark:text-slate-500">Department</span>
            <span x-show="!sidebarCollapsed">
                <svg class="w-3 h-3 text-slate-400 transition-transform duration-200"
        ...
        <div class="sidebar-category-header flex items-center cursor-pointer group mt-4" 
            ...
            <span x-show="!sidebarCollapsed" class="group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors uppercase tracking-widest font-black text-[10px] text-slate-400 dark:text-slate-500">Reports</span>
            <span x-show="!sidebarCollapsed">
                <svg class="w-3 h-3 text-slate-400 transition-transform duration-200"
        ...
        <div x-show="openCategories['reports'] || sidebarCollapsed" x-collapse>
             <a href="{{ route('teacher.reports.result-analysis') }}" class="sidebar-link {{ request()->routeIs('teacher.reports.result-analysis*') ? 'sidebar-link-active' : '' }}" title="Result Analysis">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
