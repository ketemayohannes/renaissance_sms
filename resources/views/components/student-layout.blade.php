...
<head>
    ...
    <title>{{ trim(strip_tags((string)$header)) ?: 'Student Portal' }} - {{ config('app.name', 'Renaissance SMS') }}</title>
                ...
                <div class="flex items-center gap-3 lg:gap-4 ml-auto">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('student.profile')" class="flex items-center gap-2">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')" 
                                    ...
                                    class="flex items-center gap-2 text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30">
