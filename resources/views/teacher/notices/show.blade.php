<x-teacher-layout header="Notice Details">
    <div class="space-y-6 max-w-4xl mx-auto">
        <!-- Back Button -->
        <a href="{{ route('teacher.notices.index') }}" class="inline-flex items-center gap-2 text-xs font-black uppercase tracking-wider text-slate-400 dark:text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors group">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl shadow-sm overflow-hidden relative">
            ...
            <div class="h-2.5 bg-gradient-to-r from-emerald-500 via-teal-600 to-cyan-700"></div>
            ...
            <div class="p-6 lg:p-8 space-y-6">
                ...
                <!-- Rich Text Content -->
                <div class="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 text-sm leading-relaxed whitespace-pre-line font-medium font-sans">
