<x-teacher-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap gap-4">
            ...
            <button class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-colors">
